...
namespace DBTA
{
    public partial class AdminForm : Form
    {
        ...
        private static readonly List<string[]> itemname = new List<string[]>{
            ...
            new string[]{"装机单编号","装机单名称","发布者账号","CPU编号","散热器编号","主板编号","内存编号","硬盘编号","显卡编号","电源编号","机箱编号","内存条数","发布时间"},
        ...
        private static readonly List<string[]> itemkey = new List<string[]>{
            ...
            new string[]{"LISTNO","LISTNAME","MNO","CPUNO","FANNO","BOARDNO","RAMNO","DISKNO","GPUNO","POWERNO","CASENO","RAMNUM","POSTTIME"},
